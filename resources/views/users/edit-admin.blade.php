<!--Vista de edición de usuario.
    Muestra los datos del usuario para su edición.
    Solo podrá accedeer los usuarios tipo admin.-->
<x-app-layout>
    <x-slot name="header">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-wrap justify-center mt-2">
                             ...
                             <!--Para imprimir imagen en el proyecto--> 
                                ...
                                @else
                                <img src="{{ route('user.avatar', ['filename'=>$user->img])}}" alt="Imagen de perfil" class="shadow rounded max-w-full h-auto align-middle border-none" />
                                @endif </div>
                           </div>
                    </div>
